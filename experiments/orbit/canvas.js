...
CanvasRenderingContext2D.prototype.sphere = function(x, y, z, r, angleX = 0, angleY = 0)
{
	var c = this.get3DPoint(x, y, z, angleX, angleY);
	var d = Math.sqrt(x * x + y * y + z * z);
	var R = Math.atan2(r, d) / Math.PI * 3000;
	
	this.beginPath();
	this.arc(c.x,c.y,R,0,2*Math.PI);
	this.stroke();
}
